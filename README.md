...
- **the founder is drawn as a raccoon rather than a grey lump**: a 20x28 grid with three rows of ear, a forehead with a pale blaze up the middle, a black bandit mask that flares at the eyes and comes down in two points on the cheeks, big white eyes with pupils that both look the way he is facing, a pale snout with a black nose, and a fat four-ringed tail hanging down behind him. He wears the suit over it - shoulders lit, lapels notched, a shirt and tie, a pocket square, a belt with a buckle and two shoes with a glint along the toe - in eighteen poses: standing, blinking, two walking frames, reading the letter, cheering with both fists up, the boss with something in his paw, three dance frames, two on the guitar, two chopping, two hammering and two throwing a punch, all of them dressed from the wardrobe on top;
