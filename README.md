...
| `js/sprites.js` | the procedural pixel-art engine (two fonts, icons, foliage and furniture, chickens and chicks, crops, soil, paths, terraces and ponds, procedural people, the hovering robots, machines, cars and the movers' van, vehicles, skylines, parchment and ink, CRT chrome, cubes, the raccoon, dinosaurs, fossils, dishes, billboards and their posters, the town across the road) |
