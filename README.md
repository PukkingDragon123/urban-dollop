...
**There is a band, and it plays itself.** No audio files either: a lookahead scheduler walks a grid of sixteenths and builds four parts - horns, a walking bass, a kit and a music box - out of oscillators and one buffer of noise. The menu gets **the strut**: eight bars in D minor, swung eighths, a walking bass and horn stabs on the off-beat, written for this game in the spirit of the brassy villain number the founder clearly thinks he is starring in. The valley gets the same band sat down, with brushes instead of sticks. The Chronicle gets a stinger when it lands and another when you pick. MUSIC in the settings turns the lot off.

**The Cluckton Chronicle** turns up every few minutes with an opinion about you. A newspaper spins in out of nothing, lands crooked, settles, and waits - masthead, headline, subhead, a pixel cut lifted straight out of the game and three columns of newsprint filler - and underneath it, two ways out. An egg inspector wants a fee or an argument; the crew forms a committee and wants a raise or a nice word about ownership; the council has noticed the fence; hauliers block the road; a growth fund opens and you can fill the form in honestly or generously; an election is called and you can donate to both sides or keep your hands clean. Twelve of them, each with two choices, and nothing else happens until you pick one - an unanswered front page survives a save and comes back up when you load. Most choices leave a **standing decree** on the resource bar, counting down: what every egg is worth, what the crew costs you and how much traffic the road gets all move with it, so a good headline is worth real money and a bad one is worth waiting out.
...
| `js/sprites.js` | the procedural pixel-art engine (two fonts, icons, foliage and furniture, chickens and chicks, crops, soil, paths, terraces and ponds, the animal crew and the service droids, five bugs, six roadside critters redrawn to the founder's own rules, the hovering robots, machines, cars and the movers' van, vehicles, skylines, parchment and ink, CRT chrome, cubes, the raccoon, dinosaurs, fossils, dishes, billboards and their posters, the forest across the road) |
