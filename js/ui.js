...
(() => {
  ...
  function drawSite(k, st, now) {
    ...
    /* progress plank */
    ctx.fillStyle = '#3a2a16'; ctx.fillRect(x, y - 8, w, 4);
    ctx.fillStyle = st.stage === 'work' ? '#ffd23f' : '#8a7a5a'; ctx.fillRect(x + 1, y - 7, Math.round((w - 2) * prog), 2);
  }
